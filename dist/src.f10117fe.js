...
var rootUrl = 'http://localhost:3004/users';
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/views/Views.ts":[function(require,module,exports) {
"use strict";
...
},{"./Views":"src/views/Views.ts","./UserForm":"src/views/UserForm.ts","./UserShow":"src/views/UserShow.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
