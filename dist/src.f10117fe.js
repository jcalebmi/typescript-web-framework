...
var User = function () {
  ...
  User.prototype.fetch = function () {
    ...
    axios_1.default.get("http://localhost:3004/users/" + this.get('id')).then(function (response) {
  ...
  User.prototype.save = function () {
    ...
    if (this.get('id')) {
      axios_1.default.put("http://localhost:3004/users/" + id, this.data);
    } else {
      axios_1.default.post("http://localhost:3004/users", this.data);
    }
  };
